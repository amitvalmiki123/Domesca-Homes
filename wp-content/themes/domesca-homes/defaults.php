...
function dsc_default_landing() {
	return array(
		...
		'testimonials'  => array(
			...
			'foot'        => 'Whether it\'s a family home or an investment development, we take the time to understand your goals.',
			'foot_btn'    => 'Get Your Free Quote',
			'foot_button' => 'Get Your Free Quote',
			'items'       => array(
				array(
					...
					'role'     => 'New Home Build &bull; Melbourne',
					'rating'   => 5,
				),
				array(
					...
					'role'     => '2-Unit Development &bull; Melbourne West',
					'rating'   => 5,
				),
				array(
					...
					'role'     => 'Custom New Build &bull; Melbourne North',
					'rating'   => 5,
				),
			),
		),
		'areas'         => array(
			...
			'prose'   => '<p class="lead">Based in Hillside, Victoria, we build across Melbourne&rsquo;s north and west suburbs, including Moonee Valley and surrounding regions.</p>',
			...
			'box'     => 'Get in touch and we can confirm whether your project is a fit.',
			'btn1'    => 'Check Your Suburb',
			'btn2'    => 'Call 0411 526 251',
			'button1' => 'Check Your Suburb',
			'button2' => 'Call 0411 526 251',
			'url1'    => '#enquire',
			'url2'    => 'tel:+61411526251',
			'list'    => array(
				array( 'label' => 'Hillside (3037)' ),
				array( 'label' => 'Moonee Valley' ),
				array( 'label' => 'Essendon' ),
				array( 'label' => 'Keilor & Keilor East' ),
				array( 'label' => 'Taylors Lakes' ),
				array( 'label' => 'Caroline Springs' ),
				array( 'label' => 'Maribyrnong' ),
				array( 'label' => 'Sunbury' ),
				array( 'label' => 'Strathmore' ),
				array( 'label' => 'Pascoe Vale' ),
				array( 'label' => 'Airport West' ),
				array( 'label' => 'Avondale Heights' ),
				array( 'label' => 'Niddrie' ),
				array( 'label' => 'Coburg & Brunswick' ),
			),
			'suburbs' => array(
...
function dsc_default_grev() {
	return array(
		...
		'score'       => '5.0',
		'count'       => '15+',
		'search_url'  => 'https://www.google.com/search?q=Domesca+Homes+Hillside',
		'write_url'   => 'https://www.google.com/search?q=Domesca+Homes+Hillside',
		'reviews'     => array(
			array(
				'initial' => 'R',
				'color'   => '#1a73e8',
				...
				'quote'   => 'If I could give 10 stars, I would! The work completed by Hamza and his team was outstanding. From communication to the quality of the work, I could not be happier. I highly recommend Domesca Homes.',
				'more'    => '',
			),
			array(
				'initial' => 'J',
				...
				'quote'   => 'Literally counting our blessings for having found Hamza and Domesca Homes to build our 2 units!! For the 10 months we worked with him, work progressed very well, Hamza was super easy to talk to and communicated well regarding any issues…',
				'more'    => '…and he was always positive of getting work done and stuck to his timelines well, managing delays with a lot of patience. His standards are high and his work is of top quality and we are super impressed by his materials and fittings. We are lucky to have a good relationship with our builder in an industry where most building experiences can be traumatic.',
			),
			array(
				'initial' => 'J',
				'color'   => '#137333',
				'name'    => 'Jon Siotas',
				'role'    => 'New home build',
				'quote'   => 'I cannot begin to express how happy we were with Domesca Homes in building our forever home. From the very beginning Hamza was amazing in terms of guiding us with everything, I cannot speak more highly of him…',
				'more'    => 'Having never built before, Hamza was awesome through the whole process, always communicated with us, very patient and provided us with advice throughout the build. He was able to build us an amazing house on time and within our budget. The craftsmanship and eye for detail during the build by Hamza was excellent. I would highly highly recommend him to anyone looking to build their house and would not hesitate to go straight to him if I was ever building again.',
			),
		),
		'foot'        => 'Whether it’s a family home or an investment development, we take the time to understand your goals.',
		'foot_btn'    => array(
