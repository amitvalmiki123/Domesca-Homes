...
function dsc_register_fields() {
	...
	acf_add_local_field_group( array(
		...
		'title'    => __( 'Global Contact & Footer', 'domesca-homes' ),
		'fields'   => array(
			array(
			...
			array(
				...
				'instructions'  => 'Use paragraph tags if you want to style individual <p> tags.',
			),
			array(
				...
				'type'          => 'text',
				'default_value' => '&copy;2020 Domesca Homes Pty Ltd. All rights reserved.',
			),
			array(
				'key'          => 'field_dsc_opt_footer_cols',
				'name'         => 'footer_columns',
				...
				'sub_fields'   => array(
					array( 'key' => 'field_dsc_opt_fc_title', 'name' => 'title', 'label' => 'Column title', 'type' => 'text', 'default_value' => 'Services' ),
					array(
						'key'          => 'field_dsc_opt_fc_links',
						'name'         => 'links',
						'label'        => 'Links',
						'type'         => 'repeater',
						'layout'       => 'table',
						'sub_fields'   => array(
							array( 'key' => 'field_dsc_opt_fl_label', 'name' => 'label', 'label' => 'Label', 'type' => 'text' ),
							array( 'key' => 'field_dsc_opt_fl_url', 'name' => 'url', 'label' => 'URL / anchor', 'type' => 'text' ),
							array( 'key' => 'field_dsc_opt_fl_target', 'name' => 'target', 'label' => 'Open new tab', 'type' => 'true_false', 'ui' => 1 ),
						),
					),
				),
			),
			array(
				'key'          => 'field_dsc_opt_enquiry_types',
				'name'         => 'enquiry_types',
				...
				'sub_fields'   => array(
					array( 'key' => 'field_dsc_opt_et_label', 'name' => 'label', 'label' => 'Label', 'type' => 'text' ),
				),
			),
			array(
				'key'          => 'field_dsc_opt_enquiry_stages',
				'name'         => 'enquiry_stages',
				'label'        => 'What stage are you at? options',
				'type'         => 'repeater',
				'layout'       => 'table',
				'button_label' => 'Add option',
				'sub_fields'   => array(
					array( 'key' => 'field_dsc_opt_es_label', 'name' => 'label', 'label' => 'Label', 'type' => 'text' ),
				),
			),
			array(
			...
			array(
				'key'           => 'field_dsc_opt_cf7',
				'name'          => 'contact_form_7_shortcode',
				'label'         => 'Contact Form 7 shortcode (optional)',
				'type'          => 'text',
				'default_value' => '',
				'instructions'  => 'If set, forms render this CF7 shortcode instead of the built-in AJAX form.',
			),
		),
		'location' => array(
			array(
