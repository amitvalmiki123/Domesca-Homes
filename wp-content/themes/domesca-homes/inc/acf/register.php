...
function dsc_register_fields() {
	...
	acf_add_local_field_group( array(
		...
		'fields'   => array(
			...
			array(
				'key'           => 'field_dsc_opt_service_area',
				'name'          => 'service_area',
				'label'         => 'Service area line',
				'instructions'  => 'Shown on the contact page and footer areas. Example: Melbourne&rsquo;s north & west.',
				'type'          => 'text',
				'default_value' => "Melbourne's north & west",
			),
			array(
			...
			array( 'key' => 'field_dsc_opt_shared_tab', 'name' => 'shared_tab', 'label' => 'Shared Sections', 'type' => 'tab' ),
			array(
				'key'           => 'field_dsc_opt_shared_note',
				'name'          => 'shared_note',
				'label'         => 'Shared sections',
				'instructions'  => 'These sections are used across the landing page, home page and all inner pages. Change them here once and they update on every page automatically.',
				'type'          => 'message',
			),
			array(
				'key'           => 'field_dsc_opt_shared_creds',
				'name'          => 'shared_creds',
				...
				'layout'        => 'table',
				'sub_fields'    => array(
					array( 'key' => 'field_dsc_opt_shared_creds_value', 'name' => 'value', 'label' => 'Value', 'type' => 'text' ),
					array( 'key' => 'field_dsc_opt_shared_creds_label', 'name' => 'label', 'label' => 'Label', 'type' => 'text' ),
				),
			),
			array(
				'key'           => 'field_dsc_opt_shared_tm_eyebrow',
				'name'          => 'shared_tm_eyebrow',
				'label'         => 'Google reviews — eyebrow',
				'type'          => 'text',
			),
			array(
				'key'           => 'field_dsc_opt_shared_tm_title',
				'name'          => 'shared_tm_title',
				'label'         => 'Google reviews — heading',
				'type'          => 'text',
			),
			array(
				'key'           => 'field_dsc_opt_shared_tm_lead',
				'name'          => 'shared_tm_lead',
				'label'         => 'Google reviews — intro',
				'type'          => 'textarea',
				'rows'          => 2,
			),
			array( 'key' => 'field_dsc_opt_shared_tm_rating', 'name' => 'shared_tm_rating', 'label' => 'Google rating (0.0 placeholder works too)', 'type' => 'text' ),
			array( 'key' => 'field_dsc_opt_shared_tm_count', 'name' => 'shared_tm_count', 'label' => 'Review count', 'type' => 'text' ),
			array( 'key' => 'field_dsc_opt_shared_tm_url', 'name' => 'shared_tm_url', 'label' => 'Google review URL', 'type' => 'url' ),
			array( 'key' => 'field_dsc_opt_shared_tm_foot', 'name' => 'shared_tm_foot', 'label' => 'Footer text', 'type' => 'textarea', 'rows' => 2 ),
			array( 'key' => 'field_dsc_opt_shared_tm_foot_btn', 'name' => 'shared_tm_foot_button', 'label' => 'Footer button label', 'type' => 'text' ),
			array( 'key' => 'field_dsc_opt_shared_tm_foot_url', 'name' => 'shared_tm_foot_url', 'label' => 'Footer button URL', 'type' => 'text' ),
			array(
				'key'           => 'field_dsc_opt_shared_tm_items',
				'name'          => 'shared_tm_items',
				'label'         => 'Google reviews',
				'type'          => 'repeater',
				'button_label'  => 'Add review',
				'sub_fields'    => array(
					array( 'key' => 'field_dsc_opt_shared_tm_quote', 'name' => 'quote', 'label' => 'Quote (WYSIWYG)', 'type' => 'wysiwyg', 'toolbar' => 'basic', 'media_upload' => 0 ),
					array( 'key' => 'field_dsc_opt_shared_tm_more', 'name' => 'more', 'label' => 'Continue quote (WYSIWYG, optional)', 'type' => 'wysiwyg', 'toolbar' => 'basic', 'media_upload' => 0 ),
					array( 'key' => 'field_dsc_opt_shared_tm_initials', 'name' => 'initials', 'label' => 'Avatar initial', 'type' => 'text' ),
					array( 'key' => 'field_dsc_opt_shared_tm_avatar', 'name' => 'avatar_bg', 'label' => 'Avatar background colour', 'type' => 'text', 'default_value' => '#1a73e8' ),
					array( 'key' => 'field_dsc_opt_shared_tm_name', 'name' => 'name', 'label' => 'Name', 'type' => 'text' ),
					array( 'key' => 'field_dsc_opt_shared_tm_role', 'name' => 'role', 'label' => 'Role / project', 'type' => 'text' ),
				),
			),
			array( 'key' => 'field_dsc_opt_shared_proj_eyebrow', 'name' => 'shared_proj_eyebrow', 'label' => 'Portfolio — eyebrow', 'type' => 'text' ),
			array( 'key' => 'field_dsc_opt_shared_proj_title', 'name' => 'shared_proj_title', 'label' => 'Portfolio — heading', 'type' => 'text' ),
			array( 'key' => 'field_dsc_opt_shared_proj_lead', 'name' => 'shared_proj_lead', 'label' => 'Portfolio — intro', 'type' => 'textarea', 'rows' => 2 ),
			array(
				'key'           => 'field_dsc_opt_shared_proj_filters',
				'name'          => 'shared_proj_filters',
				'label'         => 'Portfolio — filter chips',
				'type'          => 'repeater',
				'button_label'  => 'Add filter',
				'sub_fields'    => array(
					array( 'key' => 'field_dsc_opt_shared_proj_filter_key', 'name' => 'key', 'label' => 'Filter key (lower-case)', 'type' => 'text', 'default_value' => 'all' ),
					array( 'key' => 'field_dsc_opt_shared_proj_filter_label', 'name' => 'label', 'label' => 'Filter label', 'type' => 'text' ),
				),
			),
			array(
				'key'           => 'field_dsc_opt_shared_proj_items',
				'name'          => 'shared_proj_items',
				'label'         => 'Portfolio — project tiles',
				'type'          => 'repeater',
				'button_label'  => 'Add tile',
				'sub_fields'    => array(
					array( 'key' => 'field_dsc_opt_shared_proj_image', 'name' => 'image', 'label' => 'Image', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'medium' ),
					array( 'key' => 'field_dsc_opt_shared_proj_alt', 'name' => 'alt', 'label' => 'Alt', 'type' => 'text' ),
					array( 'key' => 'field_dsc_opt_shared_proj_cat', 'name' => 'category', 'label' => 'Category', 'type' => 'text' ),
					array( 'key' => 'field_dsc_opt_shared_proj_fil', 'name' => 'filters', 'label' => 'Filter keys (space separated)', 'type' => 'text' ),
					array( 'key' => 'field_dsc_opt_shared_proj_title', 'name' => 'title', 'label' => 'Title', 'type' => 'text' ),
					array( 'key' => 'field_dsc_opt_shared_proj_cls', 'name' => 'class', 'label' => 'Width', 'type' => 'select', 'choices' => array( '' => 'Default', 'is-wide' => 'Wide', 'is-half' => 'Half' ), 'default_value' => '' ),
				),
			),
		),
		'location' => array(
		...
		'fields'   => array(
			array(
				...
				'layouts'       => array(
					...
					'creds' => array(
						'label' => 'Credentials strip (shared)',
						'name'  => 'creds',
						'sub_fields' => dsc_shared_section_fields( 'ld_sh_creds' ),
					),
					'about' => array(
					...
					'projects' => array(
						'label' => 'Portfolio / projects (shared)',
						'name'  => 'projects',
						'sub_fields' => dsc_shared_section_fields( 'ld_sh_proj' ),
					),
					'testimonials' => array(
						'label' => 'Google reviews (shared)',
						'name'  => 'testimonials',
						'sub_fields' => dsc_shared_section_fields( 'ld_sh_tm' ),
					),
					'areas' => array(
			...
			array(
				...
				'layouts'       => array(
					...
					'creds' => array(
						...
						'name'  => 'creds',
						'sub_fields' => dsc_shared_section_fields( 'hm_sh_creds' ),
					),
					'about' => array(
						'label' => 'About',
						'name'  => 'about',
					...
					'projects' => array(
						'label' => 'Portfolio / projects (shared)',
						'name'  => 'projects',
						'sub_fields' => dsc_shared_section_fields( 'hm_sh_proj' ),
					),
					'developers' => array(
					...
					'testimonials' => array(
						'label' => 'Google reviews (shared)',
						'name'  => 'testimonials',
						'sub_fields' => dsc_shared_section_fields( 'hm_sh_tm' ),
					),
					'areas' => array(
						'label' => 'Areas',
						'name'  => 'areas',
	...
	/* ---------------------------------------------------------------
	 * Inner page template (converted new HTML pages: about, services,
	 * plans, builds, renovations, portfolio, contact, location, etc.)
	 * --------------------------------------------------------------- */
	acf_add_local_field_group( array(
		'key'      => 'group_dsc_inner_page',
		'title'    => __( 'Domesca Inner Page', 'domesca-homes' ),
		'fields'   => array(
			dsc_inner_page_type_fields(),
			array(
				'key'           => 'field_dsc_inner_sections',
				'name'          => 'page_sections',
				'label'         => __( 'Page sections', 'domesca-homes' ),
				'type'          => 'flexible_content',
				'button_label'  => __( 'Add section', 'domesca-homes' ),
				'layouts'       => dsc_inner_layouts(),
				'instructions' => __( 'Leave empty to use the converted HTML defaults. Shared sections (credentials, reviews, portfolio) are managed in Domesca Options → Shared Sections.', 'domesca-homes' ),
			),
		),
		'location' => array(
			array(
				array( 'param' => 'page_template', 'operator' => '==', 'value' => 'page-templates/template-inner.php' ),
			),
		),
		'menu_order' => 3,
		'show_in_rest' => true,
	...
	return array_merge(dsc_section_common_fields('hm_services'), array(
		...
		array(
			...
			'sub_fields'   => array(
				...
				array( 'key' => 'field_dsc_h_svc_url', 'name' => 'url', 'label' => 'Card link URL', 'type' => 'text' ),
