    ...
    <div class="ft__top">
      ...
      <?php else : ?>
        <nav class="ft__col" aria-label="Services">
          <h3 class="ft__h"><button class="ft__toggle" type="button" data-ft-toggle aria-expanded="true" aria-controls="ft-services">Services<span class="ft__ic" aria-hidden="true"></span></button></h3>
          <div class="ft__panel" id="ft-services">
            <ul class="ft__nav">
              <li><a href="<?php echo esc_url( home_url( '/new-builds/' ) ); ?>">New Builds</a></li>
              <li><a href="<?php echo esc_url( home_url( '/townhouse-developments/' ) ); ?>">Townhouse Developments</a></li>
              <li><a href="<?php echo esc_url( home_url( '/multi-unit-projects/' ) ); ?>">Multi-Unit Projects</a></li>
        ...
        <nav class="ft__col" aria-label="Company">
          <h3 class="ft__h"><button class="ft__toggle" type="button" data-ft-toggle aria-expanded="true" aria-controls="ft-company">Company<span class="ft__ic" aria-hidden="true"></span></button></h3>
          <div class="ft__panel" id="ft-company">
            <ul class="ft__nav">
              <li><a href="<?php echo esc_url( home_url( '/about/' ) ); ?>">About Us</a></li>
              <li><a href="<?php echo esc_url( home_url( '/portfolio/' ) ); ?>">Portfolio</a></li>
              <li><a href="<?php echo esc_url( home_url( '/location-hillside/' ) ); ?>">Hillside Builders</a></li>
      ...
      <div class="ft__col">
        <h3 class="ft__h"><button class="ft__toggle" type="button" data-ft-toggle aria-expanded="true" aria-controls="ft-touch"><?php echo esc_html( $touch_title ); ?><span class="ft__ic" aria-hidden="true"></span></button></h3>
