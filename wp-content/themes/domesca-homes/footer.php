      ...
      <?php else : ?>
        <nav class="ft__col" aria-label="Services">
          ...
          <div class="ft__panel" id="ft-services">
            <ul class="ft__nav">
              <li><a href="<?php echo esc_url( home_url( '/new-builds/' ) ); ?>">New Home Construction</a></li>
              <li><a href="<?php echo esc_url( home_url( '/townhouse-developments/' ) ); ?>">Townhouse Developments</a></li>
              <li><a href="<?php echo esc_url( home_url( '/multi-unit-projects/' ) ); ?>">Unit Developments</a></li>
              <li><a href="<?php echo esc_url( home_url( '/renovations/' ) ); ?>">Renovations &amp; Extensions</a></li>
              <li><a href="<?php echo esc_url( home_url( '/renovations/' ) ); ?>">Kitchen Renovations</a></li>
              <li><a href="<?php echo esc_url( home_url( '/renovations/' ) ); ?>">Bathroom Renovations</a></li>
              <li><a href="<?php echo esc_url( home_url( '/renovations/' ) ); ?>">Laundry Renovations</a></li>
              <li><a href="<?php echo esc_url( home_url( '/extensions/' ) ); ?>">House Extensions</a></li>
            </ul>
          </div>
        </nav>
        ...
        <nav class="ft__col" aria-label="Company">
          ...
          <div class="ft__panel" id="ft-company">
            <ul class="ft__nav">
              ...
              <li><a href="<?php echo esc_url( home_url( '/our-plans/' ) ); ?>">Our Plans</a></li>
              <li><a href="<?php echo esc_url( home_url( '/portfolio/' ) ); ?>">Portfolio</a></li>
              <li><a href="<?php echo esc_url( home_url( '/#testimonials' ) ); ?>">Testimonials</a></li>
              <li><a href="<?php echo esc_url( home_url( '/#areas' ) ); ?>">Areas We Build</a></li>
    ...
    <div class="ft__bot">
      ...
      <?php if ( ! dsc_render_footer_bottom( 'footer_bottom' ) ) : ?>
        <nav aria-label="Footer">
          ...
          <a href="<?php echo esc_url( home_url( '/portfolio/' ) ); ?>">Projects</a>
          <a href="<?php echo esc_url( home_url( '/contact-us/' ) ); ?>">Contact</a>
          <?php 
          $priv_url = function_exists( 'get_privacy_policy_url' ) && get_privacy_policy_url() ? get_privacy_policy_url() : home_url( '/privacy-policy/' );
          ?>
          <a href="<?php echo esc_url( $priv_url ); ?>">Privacy Policy</a>
        </nav>
      <?php endif; ?>
    </div>
  </div>
...
<div class="mbar">
  ...
  <a class="is-primary" href="#enquire">
