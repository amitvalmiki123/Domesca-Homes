		...
		'fields'   => array(
			...
			array(
				...
				'layouts'       => array(
					...
					'creds'        => array( 'label' => 'Credentials strip', 'name' => 'creds', 'sub_fields' => dsc_landing_creds_fields() ),
					...
					'projects'     => array( 'label' => 'Portfolio / projects', 'name' => 'projects', 'sub_fields' => dsc_page_projects_fields() ),
					'developers'   => array( 'label' => 'Developers / investors', 'name' => 'developers', 'sub_fields' => dsc_home_developers_fields() ),
					'testimonials' => array( 'label' => 'Testimonials', 'name' => 'testimonials', 'sub_fields' => dsc_landing_testimonials_fields() ),
				...
				'instructions' => __( 'Leave empty to use the selected page type defaults from the converted HTML.', 'domesca-homes' ),
			),
		),
		'location' => array(
			array(
