...
<section class="sec" id="about">
  <div class="wrap wrap-wide about__grid">
    <div class="about__media rv">
      <div class="shot-a"><?php dsc_row_image( $section, 'image_a', $about['image_a'], 'Open-plan kitchen and living area with feature pendant lighting in a Domesca Homes custom build' ); ?></div>
      <div class="shot-b"><?php dsc_row_image( $section, 'image_b', $about['image_b'], 'Contemporary single-storey new home built by Domesca Homes' ); ?></div>
      ...
      <div class="prose" style="margin-top:1.5rem">
        ...
        <?php if ( wp_strip_all_tags( $key( 'more', $about['more'] ) ) ) : ?>
          <div class="more" id="about-more">
            <div>
              <?php echo wp_kses_post( $key( 'more', $about['more'] ) ); ?>
            </div>
          </div>
        <?php endif; ?>
      </div>
