...
if ( empty( $sections ) ) :
	...
	get_template_part( 'template-parts/sections/page-plans' );
	get_template_part( 'template-parts/sections/page-why' );
	get_template_part( 'template-parts/sections/landing-process' );
	get_template_part( 'template-parts/sections/page-projects' );
